...
包管理器就像是手机上的应用商店一样，当我们需要往电脑上安装应用的时候就可以从它那里去下载我们需要的应用。不同的Linux发行版也有不同的包管理器。

包管理器的作用不光是帮你下载软件，它是你的软件管家，他能够帮你找软件、下载软件安装包、安装软件、更新和卸载，这些你都不用操心，它一个人都能帮你完成。

而包管理器也可以分为**系统级的包管理器**和**编程语言的包管理器**。



像我们使用的apt、winget、brew这样的命令都可以理解为是系统级的包管理器

而像pip、npm这些都是编程语言的包管理器
