...
![](../assets/technical_file/Hisi无线通信模组/file-20260528165838557.png)
...
![](../assets/technical_file/Hisi无线通信模组/file-20260528174859197.png)
...
![](../assets/technical_file/Hisi无线通信模组/file-20260528180709001.png)
...
![](../assets/technical_file/Hisi无线通信模组/file-20260528181104349.png)
...
2、首先我们打开**设置**（快捷键win+i），进入系统->声音->高级->更多声音设置

![](../assets/technical_file/Hisi无线通信模组/file-20260526175210643.png)

3、在弹出的窗口中我们在最上面一栏中点击**录制**，在设备列表中找到带有**Audio-HID**的设备右键选择**属性**。

4、在弹出的窗口的最上面一栏选择侦听，勾选**侦听此设备**。

![](assets/Hisi无线通信模组/file-20260526175210641.png)

5、之后再进入到**高级**一栏中。选择默认格式为“**1通道，16位，16000HZ（磁带录像机音质）**”。

![](assets/Hisi无线通信模组/file-20260526175210640.png)

点击应用再点击确定即可。

6、回到先前声音设置界面，我们对麦克风说话可以看到音量条有明显的跳动，代表麦克风接入正常。

这时我们回到板子上，可以观察到下图所示的这两个**连接指示灯**应该有亮起，代表这两块板子连接成功了。

![](../assets/technical_file/Hisi无线通信模组/file-20260529101308384.png)

至此PC端音频设备配置就完成了。

### 键盘码指令的发送

![](../assets/technical_file/Hisi无线通信模组/file-20260528182018969.png)
...
![](../assets/technical_file/Hisi无线通信模组/file-20260528182708414.png)
...
![](../assets/technical_file/Hisi无线通信模组/file-20260528135351771.png)

3、在发送区输入自定义内容，点击发送。

4、回到串口助手，我们可以看到，我们接收到了刚刚发送的内容。

![](../assets/technical_file/Hisi无线通信模组/file-20260528140523566.png)
